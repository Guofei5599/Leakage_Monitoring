...
namespace 照明模块软件
{
    public partial class RoundButtonEx : Button
    {
        #region --成员变量--
        ...
        public RoundButtonEx()
        {
            ...
            BorderColor = Color.FromArgb(82, 196, 188);
            FocusBorderColor = Color.FromArgb(82, 196, 188);
            IconColor = Color.Black;
            BorderWidth = 0;
            //BorderTransparent = 255;
            GradientAngle = 90;
