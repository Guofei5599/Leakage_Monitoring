...
namespace 照明模块软件
{
    public partial class RoundPanel : Panel
    {
        ...
        private int _distanceToBorder = 3;

        private Color _buttonCenterColorEnd = Color.White;
        private Color _buttonCenterColorStart = Color.White;
        ...
        {
            get { return _distanceToBorder; }
            set
            {
                _distanceToBorder = value;
                base.Invalidate();
            }
        }
        ...
        [Category("Appearance")]
        public Color ButtonCenterColorEnd
        {
            get { return _buttonCenterColorEnd; }
            set
            {
                _buttonCenterColorEnd = value;
                base.Invalidate();
            }
        }
        ...
        [Category("Appearance")]
        public Color ButtonCenterColorStart
        {
            get { return _buttonCenterColorStart; }
            set
            {
                _buttonCenterColorStart = value;
                base.Invalidate();
            }
        }
        ...
        public RoundPanel()
        {
            ...
            DistanceToBorder = 3;
            ButtonCenterColorStart = Color.FromArgb(82, 196, 188);
            ButtonCenterColorEnd = Color.FromArgb(82, 196, 188);
            BorderColor = Color.Transparent;
            FocusBorderColor = Color.Transparent;
            //IconColor = Color.FromArgb(82, 196, 188);
            BorderWidth = 2;
            //BorderTransparent = 0;
            GradientAngle = 90;
